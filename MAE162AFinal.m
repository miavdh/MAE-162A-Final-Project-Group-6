...
for r15 = r15min:deltar15:r15max
    ...
    phimin = rightAngle - pi/180;
    phimax = rightAngle + pi/180;
    ...
    for r5 = r5min:deltar5:r5max
        [t5, t6] = NR(r1, r2, r3, r4, r5, r6, r26, r15, ...
        t1, t2r, t3r, t4r, t15r, t26r, LR);
        % CoM test
        CoM = r6*sin(t6) / 2 + del3;
        if (abs(CoM) < 1 && abs(t6) < 1/180)
            if (r5right(1,1) == 0) 
                r5right(1,1) = r5;
                r15right(1,1) = r15;
                t5right(1,1) = t5;
